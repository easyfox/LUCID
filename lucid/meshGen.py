...
#Search points and construct structure to return for differents bounding boxes
...
#Detect abnormal points and launch readjustment of its
...
#Verify if the points is really abnormal and reajust it if necessary
def checkConsistancy(image,storage,storageInfo,warningList,center,iden):
    ...
    :param storageInfo: Values of constant of line equation foreach internal points. a and b for an equation ax+b.
    :type storageInfo: Array[(float,float)...(float,float)].
    :param warningList: List of abnormal points detected
    :type warningList:[uint...uint]
    :param center: The center choosen
    :type center: Tuple (uint,uint)
    :param iden: Id of abnormal points studied
    :type iden: uint
